...
class PrimevideoBot:
    ...
    def random_episode(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="av-search"]/div[2]/div[1]/div[1]/div/div[2]/div[1]/div[1]/a')\
            .click()
        sleep(1)
        self.driver.find_element_by_xpath('//*[@id="a-page"]/div[2]/div[2]/div/div/div[2]/div/div/div[3]/div[1]/div/div[1]/div/div/label')\
            .click()
        sleep(1)
        temporada = randint(1,9)
        print('Temporada ' + str(temporada))
        
        self.driver.find_element_by_xpath('//*[@id="a-page"]/div[2]/div[2]/div/div/div[2]/div/div/div[3]/div[1]/div/div[1]/div/div/ul/li[{}]/a'.format(temporada))\
            .click()
        sleep(2)
...
bot = PrimevideoBot(username, pasword)
bot.random_episode()
